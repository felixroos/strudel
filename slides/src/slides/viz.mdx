...
note("E4 F#4 B4 C#5 D5 F#4 E4 C#5 B4 F#4 D5 C#5")
  ...
  ._pianoroll({height:200,width:800})
`}
/>
...
).toTactus(32)._spiral({colorizeInactive: true, from: 0, to:4,size:500}))
    
p2: s("clap hh!3 clap - clap -").n(2).color("white green white green").legato(0.125)`}
/>

- strudel is a german word for vortex
- a tidal wave causes a vortex / strudel 🌊 
- cyclical time flows in a spiral
